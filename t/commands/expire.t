...
my $cmd = Inventory::Command::Expire->create(order_number => 1234);
...
is($order_data->{'order_class'}, 'Inventory::Order::Expiration', 'It is of the correct type');
...
like($warnings[0], qr/Expiration order 1234 on .*:\s+-3/, 'Saw history for expire');
